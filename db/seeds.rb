...
transaction = Transaction.create(account_id: account.id, item_id: outlander_dress.id, amount: 10, kind: "deposit", date: Date.today, description: "Found $10")

transaction_two = Transaction.create(account_id: account.id, item_id: outlander_dress.id, amount: 10, kind: "withdraw", date: Date.today, description: "Taking $10")